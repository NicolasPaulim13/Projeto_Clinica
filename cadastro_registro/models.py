...
class CadastroRegistro(models.Model):
    ...
    imagem_perfil = models.ImageField(upload_to='imagens_perfil/', default='img/perfil-icon.png', null=True, blank=True)
    tipo_usuario = models.CharField(max_length=50, default='paciente')  # Novo campo com valor padrão "paciente"
